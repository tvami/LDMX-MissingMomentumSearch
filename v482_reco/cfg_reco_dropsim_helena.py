"""Re-run the reco step in v4.8.2 with the helena ECal BDT.

Input : the preselection skims, /home/vamitamas/Samples8GeV/pres_skim/<sample>/*_pres.root
Output: /home/vamitamas/Samples8GeV/reco_dropsim_v482_helena/<sample>/*_pres_reco.root
...
outputDir = "/home/vamitamas/Samples8GeV/reco_dropsim_v482_helena/" + str(
    fileName.split("/")[-2]
)
...
ecal_veto = ecal_vetos.EcalVetoProcessor(
    bdt_file="/home/vamitamas/ldmx-analysis/v4.8.2/ldmx-sw/helena.onnx",
    bdt_feature_config="helena",
)
# NOTE: disc_cut is left at segmip's 0.99741; helena has no tuned working point.
